...
using Dijits.Authentication.Result;
...
namespace Dijits.Authentication.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private string ValidateClientAndRedirectUri(HttpRequestMessage request, ref string redirectUriOutput)
        {
            ...
            var client = AudiencesStore.FindAudience(clientId);
        ...
        private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            ...
            if (provider == "Facebook")
            {
                ...
                var appToken = "853901721335004|3E4Ap49SrPjTBj3ryi83ZdudXP0";
        ...
        private JObject GenerateLocalAccessTokenResponse(string userName)
        {
            ...
            props.Dictionary.Add("audience", "099153c2625149bc8ecb3e85e03f0022");
